import os
os.chdir(r'C:\Users\unayd\Desktop\EC523_Final_Project\DnCNN')
...
class DenoisingDatatset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        batch_y, _, max_value= nm.poissonpoissonnoise_withmaxvalue(batch_x,
                                            self.eta_min, self.eta_max,
                                            self.dose, t=100)

        return batch_y, batch_x, max_value
...
def datagenerator(data_dir=r"C:\Users\unayd\Desktop\EC523_Final_Project\DnCNN\data\Train400", verbose=False):
    """
...
if __name__ == "__main__":
    data_dir = r"C:\Users\unayd\Desktop\EC523_Final_Project\DnCNN\data\Train400"
